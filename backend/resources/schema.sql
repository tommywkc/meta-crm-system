...
(101, '基礎理論', 'CRM 基礎概念與重要性', 30, '2026-07-01 10:00:00', '2026-07-01 12:00:00', 50000, 30),
(101, '實作演練', 'CRM 系統操作實作', 30, '2026-07-08 10:00:00', '2026-07-08 12:00:00', 50000, 30),
(102, '主題演講', '高效銷售策略分享', 100, '2026-07-05 14:00:00', '2026-07-05 16:00:00', 50001, 100),
(103, '語法入門', 'Python 基礎語法與資料型態', 30, '2026-08-10 09:00:00', '2026-08-10 12:00:00', 50002, 30),
(103, '流程控制', '條件判斷與迴圈', 30, '2026-08-10 13:00:00', '2026-08-10 15:00:00', 50002, 30),
(103, '函數與模組', '函數定義與模組使用', 30, '2026-08-10 15:00:00', '2026-08-10 17:00:00', 50002, 30),
(104, '數據清理', '數據預處理與清理技巧', 25, '2026-08-15 10:00:00', '2026-08-15 13:00:00', 50000, 25),
(104, '視覺化分析', '數據視覺化與報表製作', 25, '2026-08-15 13:00:00', '2026-08-15 16:00:00', 50000, 25),
(105, '趨勢分享', '2026 數位行銷趨勢與案例', 100, '2026-08-20 14:00:00', '2026-08-20 17:00:00', 50001, 100),
(106, 'ML 基礎概念', '機器學習基本原理', 40, '2026-09-01 09:00:00', '2026-09-01 11:00:00', 50014, 40),
(106, '監督式學習', '分類與回歸演算法', 40, '2026-09-01 11:00:00', '2026-09-01 13:00:00', 50014, 40),
(106, '非監督式學習', '聚類與降維技術', 40, '2026-09-01 14:00:00', '2026-09-01 16:00:00', 50014, 40),
(106, '深度學習入門', '神經網路基礎', 40, '2026-09-01 16:00:00', '2026-09-01 18:00:00', 50014, 40),
(107, '進階函數', 'VLOOKUP、INDEX、MATCH 等函數', 50, '2026-09-05 13:00:00', '2026-09-05 15:00:00', 50002, 50),
(107, '樞紐分析表', '樞紐分析與數據分析', 50, '2026-09-05 15:00:00', '2026-09-05 17:00:00', 50002, 50),
(108, '創業經驗談', '從零到一的創業旅程', 80, '2026-09-10 19:00:00', '2026-09-10 21:00:00', 50020, 80),
(109, '設計原則', 'UI/UX 設計基礎原則', 35, '2026-09-15 10:00:00', '2026-09-15 12:00:00', 50000, 35),
(109, 'Figma 實作', 'Figma 設計工具實作', 35, '2026-09-15 13:00:00', '2026-09-15 15:00:00', 50000, 35),
(109, '原型製作', '互動原型製作與測試', 35, '2026-09-15 15:00:00', '2026-09-15 16:00:00', 50000, 35),
(110, '前端基礎', 'HTML、CSS、JavaScript', 30, '2026-09-20 09:00:00', '2026-09-20 11:30:00', 50014, 30),
(110, 'React 框架', 'React 組件開發', 30, '2026-09-20 11:30:00', '2026-09-20 14:00:00', 50014, 30),
(110, '後端開發', 'Node.js 與 Express', 30, '2026-09-20 14:30:00', '2026-09-20 16:30:00', 50014, 30),
(110, '資料庫整合', 'PostgreSQL 整合實作', 30, '2026-09-20 16:30:00', '2026-09-20 18:00:00', 50014, 30),
(111, '理財策略', '個人投資理財規劃', 120, '2026-09-25 18:30:00', '2026-09-25 20:30:00', 50001, 120),
(112, '簡報設計', '簡報視覺設計原則', 40, '2026-10-01 14:00:00', '2026-10-01 15:30:00', 50002, 40),
(112, '簡報演說', '有效的簡報技巧', 40, '2026-10-01 15:30:00', '2026-10-01 17:00:00', 50002, 40),
(113, 'iOS 開發基礎', 'Swift 語言與 iOS 開發', 25, '2026-10-05 09:00:00', '2026-10-05 11:30:00', 50014, 25),
(113, 'Android 開發', 'Kotlin 與 Android Studio', 25, '2026-10-05 11:30:00', '2026-10-05 14:00:00', 50014, 25),
(113, 'UI 設計實作', '手機介面設計與實作', 25, '2026-10-05 14:30:00', '2026-10-05 16:00:00', 50014, 25),
(113, 'App 發佈', 'App Store 與 Play Store 上架', 25, '2026-10-05 16:00:00', '2026-10-05 18:00:00', 50014, 25),
(114, '溝通技巧', '職場有效溝通策略', 90, '2026-10-10 19:00:00', '2026-10-10 21:00:00', 50020, 90),
(115, '資料庫設計', '關聯式資料庫設計原則', 30, '2026-10-15 10:00:00', '2026-10-15 12:30:00', 50000, 30),
(115, 'SQL 進階', '複雜查詢與優化', 30, '2026-10-15 13:00:00', '2026-10-15 15:00:00', 50000, 30),
(115, '效能調校', '資料庫效能優化技巧', 30, '2026-10-15 15:00:00', '2026-10-15 17:00:00', 50000, 30),
(116, '社群策略', 'Facebook、Instagram 行銷策略', 45, '2026-10-20 13:00:00', '2026-10-20 15:30:00', 50001, 45),
(116, '廣告投放', '社群廣告投放實務', 45, '2026-10-20 15:30:00', '2026-10-20 18:00:00', 50001, 45),
(117, '主題演講', 'AI 機會與挑戰探討', 150, '2026-10-25 14:00:00', '2026-10-25 16:00:00', 50014, 150),
(118, '區塊鏈原理', '區塊鏈技術基礎', 35, '2026-11-01 09:00:00', '2026-11-01 11:30:00', 50000, 35),
(118, '智能合約', 'Smart Contract 開發', 35, '2026-11-01 12:00:00', '2026-11-01 14:30:00', 50000, 35),
(118, '加密貨幣', '加密貨幣與 DeFi', 35, '2026-11-01 14:30:00', '2026-11-01 17:00:00', 50000, 35),
(119, '攝影理論', '相機操作與基礎理論', 20, '2026-11-05 10:00:00', '2026-11-05 13:00:00', 50002, 20),
(119, '實拍練習', '外拍實作與作品評析', 20, '2026-11-05 13:00:00', '2026-11-05 16:00:00', 50002, 20),
(120, '剪輯軟體', 'Premiere Pro 基礎操作', 25, '2026-11-10 13:00:00', '2026-11-10 15:30:00', 50000, 25),
(120, '進階特效', '特效與調色技巧', 25, '2026-11-10 15:30:00', '2026-11-10 18:00:00', 50000, 25),
(121, '領導力發展', '領導力與團隊管理實務', 100, '2026-11-15 18:00:00', '2026-11-15 20:00:00', 50020, 100),
(101, '基礎理論', 'CRM 基礎概念與重要性', 30, '2025-07-15 10:00:00', '2025-07-15 12:00:00', 50000, 30),
(101, '基礎理論', 'CRM 基礎概念與重要性', 30, '2026-07-22 10:00:00', '2026-07-22 12:00:00', 50000, 30),
(101, '基礎理論', 'CRM 基礎概念與重要性', 30, '2026-07-29 10:00:00', '2026-07-29 12:00:00', 50000, 30),
(103, '語法入門', 'Python 基礎語法與資料型態', 30, '2026-08-11 09:00:00', '2026-08-11 12:00:00', 50002, 30),
(103, '語法入門', 'Python 基礎語法與資料型態', 30, '2026-08-12 09:00:00', '2026-08-12 12:00:00', 50002, 30),
(110, '前端基礎', 'HTML、CSS、JavaScript', 30, '2026-09-21 09:00:00', '2026-09-21 11:30:00', 50014, 30),
(110, '前端基礎', 'HTML、CSS、JavaScript', 30, '2026-09-22 09:00:00', '2026-09-22 11:30:00', 50014, 30);
