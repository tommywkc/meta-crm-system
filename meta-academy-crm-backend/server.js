...
// In-memory users for demo (passwords hashed)
// Passwords: member -> password, sales -> password, admin -> adminpass
const users = [
  { id: 1, username: 'member', passwordHash: bcrypt.hashSync('password', 10), role: 'member' },
  { id: 2, username: 'sales', passwordHash: bcrypt.hashSync('password', 10), role: 'sales' },
  { id: 3, username: 'admin', passwordHash: bcrypt.hashSync('adminpass', 10), role: 'admin' }
];
